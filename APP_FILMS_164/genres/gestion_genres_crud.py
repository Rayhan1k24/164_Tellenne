...
def genre_update_wtf():
    ...
    try:
        ...
        if request.method == "POST" and form_update.submit.data:
            ...
            str_sql_update_intitulegenre = """UPDATE t_agents SET nom = %(value_name_genre)s, 
            prenom = %(value_date_genre_essai)s WHERE ID_agents = %(value_id_genre)s """
            with DBconnection() as mconn_bd:
            ...
            str_sql_id_genre = "SELECT ID_agents, nom, prenom FROM t_agents " \
            ...
            form_update.date_genre_wtf_essai.data = data_nom_genre["prenom"]
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_del.data:
                ...
                str_sql_delete_films_genre = """DELETE FROM t_agents_mails WHERE FK_agents = %(value_id_genre)s"""
